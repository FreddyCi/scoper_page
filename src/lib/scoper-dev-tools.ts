...
export function exposeScoperDevGlobals(): void {
  ...
  if (!devGlobalsAnnounced) {
    ...
    console.debug(
      '[Scoper dev] ECP audit: Scoper.getEcpAgentAuditLog() · Scoper.printEcpAgentAuditLog() · Scoper.clearEcpAgentAuditLog() · Scoper.setPdfMarkDrawingMode(true|false) · Scoper.setPdfMarkTool("pen"|"highlighter"|"eraser"|"rect"|"ellipse")',
    )
  }
}
